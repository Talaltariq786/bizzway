...
class _CustomerHomeScreenState extends State<CustomerHomeScreen> {
  ...
  List<Business> get _visibleBusinesses {
    ...
    if (_searchQuery.isNotEmpty) {
      list = list.where((b) =>
          ...
          b.businessTypeId.toLowerCase().contains(_searchQuery.toLowerCase())).toList();
    }
    return list;
  }

  List<Business> get _topRated {
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  ..._topRated.take(3).map((b) => _cartSuggestCard(b)),
                ],
              ),
            ),
          ],
  ...
  Widget _buildLiveBusiness() {
    ...
    final scopedProducts = prodProv.productsForBusiness(bizId);
      ...
      children: [
        Padding(
          ...
          child: _sectionTitle(label,
              '${_visibleBusinesses.where((b) => b.isOpen).length} open'),
        ),
        SizedBox(
          height: 185,
          child: ListView.builder(
  ...
  Business? _resolveCartBusiness() {
    ...
    for (final b in allDummyBusinesses) {
